  ...
  return (
    <div className="bg-[#FFFFFF] min-h-screen pb-24 overflow-x-hidden flex flex-col items-center font-sans">
      ...
      <div className="w-full max-w-[480px] flex flex-col bg-white">
        {/* 1. Imagem / Banner do Topo */}
        <HeroSection />

        {/* 2. Barra de Ajuda com Ícone de Alto-falante e Redes Sociais */}
        ...
        {/* 3. Botões Vermelhos de Ação (Bordas leves rounded-md / rounded-lg iguais à imagem) */}
        <div className="px-3 py-3 space-y-2.5">
          {/* Botão Convide Amigos */}
          <button
            onClick={() => navigate('/convite')}
            className="w-full h-[48px] bg-[#C62828] hover:bg-[#B71C1C] active:scale-[0.99] text-white rounded-md font-medium text-[16px] flex items-center justify-center gap-2.5 transition-all shadow-none border-none"
          >
            <UserPlus className="w-5 h-5 text-white" strokeWidth={2.2} />
            <span>Convide amigos</span>
          </button>

          {/* Grid dos 2 Botões: Retirar dinheiro & Recarrega */}
          <div className="grid grid-cols-2 gap-2.5">
            <button
              onClick={() => navigate('/retirada')}
              className="h-[48px] bg-[#C62828] hover:bg-[#B71C1C] active:scale-[0.99] text-white rounded-md font-medium text-[15px] flex items-center justify-center gap-2 transition-all shadow-none border-none px-2"
            >
        ...
        {/* 4. Seção "Meu produto" com Reprodutor de Vídeo Automático */}
        <div className="mt-2 px-3 flex flex-col items-center">
          {/* Badge "Meu produto" */}
          <div className="inline-block bg-[#C62828] text-white text-[13px] font-normal px-5 py-1 rounded-md mb-3">
            Meu produto
          </div>

          {/* Card com o Vídeo CanadianSolar com Autoplay */}
          <div className="w-full bg-black rounded-md overflow-hidden border border-gray-100 shadow-sm relative aspect-video flex items-center justify-center">
            <video
