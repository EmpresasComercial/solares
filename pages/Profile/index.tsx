...
function ProfileSkeleton() {
  return (
    <div className="w-full min-h-screen bg-[#F2F2F2] pb-24 font-sans antialiased select-none flex flex-col items-center px-3.5 pt-3.5">
...
export default function Profile() {
  ...
  return (
    <div className="w-full min-h-screen bg-[#F2F2F2] pb-24 font-sans antialiased text-[#191919] select-none flex flex-col items-center px-3.5 pt-3.5">

      {/* BLOCO 1: Cabeçalho do Perfil & Saldos */}
      ...
      {/* BLOCO 3: Menu de Ações e Configurações */}
      ...
      {/* BOTÃO LOGOUT (Original Plano e Quadrado) */}
