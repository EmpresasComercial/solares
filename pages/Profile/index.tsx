...
function ProfileSkeleton() {
  return (
    <div className="w-full min-h-screen bg-[#F2F2F2] pb-24 font-sans antialiased select-none flex flex-col items-center">
      <div className="w-full max-w-[480px] px-3.5 pt-3.5 space-y-3">
  ...
  return (
    <div className="w-full min-h-screen bg-[#F2F2F2] pb-24 font-sans antialiased text-[#191919] select-none flex flex-col items-center">
      <div className="w-full max-w-[480px] px-3.5 pt-3.5 space-y-3">
        ...
        {/* CARD 1: Cabeçalho do Perfil & Saldos */}
        ...
        {/* CARD 2: Pedidos & Atividades */}
        <div className="bg-white rounded-xl px-4 pt-4 pb-3.5 shadow-sm">
          <div
        ...
        {/* CARD 3: Menu de Ações e Configurações */}
        <div className="bg-white rounded-xl divide-y divide-[#F5F5F5] shadow-sm overflow-hidden">
          <div
        ...
        <div className="pt-1 pb-3">
          <button
            ...
            className="w-full h-[44px] rounded-xl bg-[#FE384F] hover:bg-[#E02E44] active:scale-[0.99] text-white font-normal text-[14px] transition-all shadow-sm flex items-center justify-center gap-2 cursor-pointer"
          >
