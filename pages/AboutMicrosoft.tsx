      ...
      <main className="w-full max-w-[480px] px-4 pt-4 space-y-3">
        ...
        <div className="bg-white rounded-none shadow-[0_1px_2px_rgba(0,0,0,0.03)] p-4 space-y-3">
          <div>
            <h2 className="text-[13.5px] font-bold text-[#202020] uppercase tracking-tight">
              Termos e Condições do Programa de Dropshipping AliExpress24
            </h2>
          ...
          <div className="text-[12.5px] text-[#555555] leading-relaxed space-y-2 font-normal pt-1">
            <p>
              Este Contrato de Usuário do Programa de Dropshipping AliExpress24 (o “Contrato”), juntamente com as Regras Relevantes, estabelece os termos e condições aplicáveis à participação no Programa de Dropshipping AliExpress24 (o “Programa”).
            </p>
            <p>
        ...
        <div className="bg-white rounded-none shadow-[0_1px_2px_rgba(0,0,0,0.03)] p-4 space-y-2.5">
          ...
          <div className="text-[12.5px] text-[#555555] leading-relaxed space-y-2">
            <p>
              <strong className="text-[#202020] font-semibold">1.1 “Plataforma AliExpress24”:</strong> significa a plataforma de comércio eletrônico AliExpress24, incluindo seus websites, subdomínios e aplicativos móveis.
            </p>
            <p>
        ...
        <div className="bg-white rounded-none shadow-[0_1px_2px_rgba(0,0,0,0.03)] p-4 space-y-2.5">
          ...
          <div className="text-[12.5px] text-[#555555] leading-relaxed space-y-2">
            <p>
              <strong className="text-[#202020] font-semibold">2.1</strong> Este Contrato, juntamente com as Regras Relevantes, constitui o acordo integral entre o Participante e o AliExpress24 relativamente ao uso do DS Center e dos serviços prestados no âmbito do Programa, incluindo os termos de adesão, termos de uso, contratos de serviços aplicáveis e todas as regras, políticas e condições publicadas periodicamente no DS Center.
            </p>
            <p>
              <strong className="text-[#202020] font-semibold">2.2</strong> As Regras Relevantes fazem parte integrante deste Contrato e possuem a mesma força. Em caso de conflito, prevalecerão as políticas e os termos publicados pelo AliExpress24, seguidos das demais Regras Relevantes.
            </p>
            <p>
              <strong className="text-[#202020] font-semibold">2.3</strong> O AliExpress24 poderá alterar ou reformular as Regras Relevantes periodicamente, inclusive sem aviso prévio. As alterações entrarão em vigor na data indicada no anúncio. A continuação do uso do DS Center ou do Programa após a publicação será considerada aceitação das alterações.
            </p>
          </div>
        </div>
        ...
        <div className="bg-white rounded-none shadow-[0_1px_2px_rgba(0,0,0,0.03)] p-4 space-y-2.5">
          ...
          <div className="text-[12.5px] text-[#555555] leading-relaxed space-y-2">
            ...
            <p>
              <strong className="text-[#202020] font-semibold">3.2</strong> O AliExpress24 poderá suspender ou encerrar os serviços se verificar que o Participante não cumpre os requisitos deste Contrato ou não é considerado adequado para participar do Programa.
            </p>
          </div>
        </div>
        ...
        <div className="bg-white rounded-none shadow-[0_1px_2px_rgba(0,0,0,0.03)] p-4 space-y-2.5">
          ...
          <div className="text-[12.5px] text-[#555555] leading-relaxed space-y-2">
            <p>
              <strong className="text-[#202020] font-semibold">4.1</strong> O Programa fornece serviços técnicos eletrônicos para apoiar o negócio de dropshipping do Participante, permitindo navegar por mercadorias selecionadas, realizar pedidos por ferramentas aprovadas e utilizar outras funcionalidades disponibilizadas e atualizadas periodicamente pelo AliExpress24.
            </p>
            <p>
              <strong className="text-[#202020] font-semibold">4.2</strong> O AliExpress24 poderá limitar determinados recursos do DS Center. O DS Center não representa o Vendedor em transações específicas. O AliExpress24 não controla nem se responsabiliza pela qualidade, segurança, legalidade ou disponibilidade das mercadorias ou serviços oferecidos pelos Vendedores, nem pela capacidade destes de concluir uma venda.
            </p>
            <p>
              <strong className="text-[#202020] font-semibold">4.3</strong> O AliExpress24 poderá remover qualquer produto ou serviço da Plataforma ou dos Serviços, a qualquer momento e por qualquer motivo, sem aviso prévio.
            </p>
            <p>
              <strong className="text-[#202020] font-semibold">4.4</strong> O AliExpress24 poderá cobrar pelo acesso ou utilização do DS Center ou de determinadas funcionalidades, mediante aviso prévio de 30 dias.
            </p>
          </div>
        </div>
        ...
        <div className="bg-white rounded-none shadow-[0_1px_2px_rgba(0,0,0,0.03)] p-4 space-y-2.5">
          ...
          <div className="text-[12.5px] text-[#555555] leading-relaxed space-y-2.5">
            <p>
              <strong className="text-[#202020] font-semibold">5.1</strong> O Participante é responsável por todas as atividades realizadas na sua conta e pela proteção dos seus dados de acesso. Qualquer uso não autorizado ou violação de segurança deverá ser comunicado imediatamente ao AliExpress24.
            </p>
            <div>
              <p>
              ...
              <p className="mt-1.5">
                O abuso poderá resultar na retenção de pedidos de devolução ou reembolso, limitação da conta e cobrança das perdas sofridas pelo AliExpress24 ou pelos Vendedores.
              </p>
            </div>
            <p>
              <strong className="text-[#202020] font-semibold">5.3</strong> Disputas, devoluções e pedidos de reembolso deverão ser realizados de forma razoável e de acordo com a situação real dos produtos e da logística. O AliExpress24 apoiará a resolução conforme suas regras e políticas.
            </p>
            <p>
              <strong className="text-[#202020] font-semibold">5.4</strong> Todos os documentos e provas apresentados em disputas deverão ser verdadeiros e estar de acordo com as regras do AliExpress24. É proibido utilizar documentos ou provas de outros compradores ou encomendas, ou praticar qualquer fraude. A violação poderá resultar em decisão desfavorável, limitação de funcionalidades ou encerramento da conta.
            </p>
            <p>
            ...
            <p>
              <strong className="text-[#202020] font-semibold">5.7</strong> O AliExpress24 poderá suspender ou encerrar a conta caso o Participante tente estabelecer contato ou relacionamento direto com Vendedores fora das ferramentas, serviços ou canais disponibilizados pela Plataforma.
            </p>
            <p>
            ...
            <div>
              ...
              <ul className="list-disc pl-5 mt-1.5 space-y-1 text-[#555555]">
                ...
                <li>possui autorização dos Consumidores Finais para compartilhar os seus dados pessoais com o AliExpress24 e os Vendedores para realizar pedidos;</li>
        ...
        <div className="bg-white rounded-none shadow-[0_1px_2px_rgba(0,0,0,0.03)] p-4 space-y-2.5">
          ...
          <div className="text-[12.5px] text-[#555555] leading-relaxed space-y-2">
            <p>
              <strong className="text-[#202020] font-semibold">6.1</strong> O Participante não poderá utilizar, solicitar ou registrar marcas, nomes comerciais, logotipos, nomes de domínio ou outros elementos idênticos ou semelhantes aos pertencentes ao AliExpress24, às suas afiliadas ou entidades relacionadas.
            </p>
            <p>
              <strong className="text-[#202020] font-semibold">6.2</strong> É proibido copiar ou modificar ícones, botões, banners, arquivos gráficos ou conteúdos disponibilizados no DS Center, nas lojas dos Vendedores ou nos domínios do AliExpress24, salvo autorização expressa e escrita.
            </p>
            <p>
              <strong className="text-[#202020] font-semibold">6.3</strong> Este Contrato não concede ao Participante qualquer direito de propriedade, licença ou interesse sobre produtos, serviços, tecnologia ou Direitos de Propriedade Intelectual do AliExpress24, salvo quando expressamente acordado por escrito.
            </p>
            <p>
              <strong className="text-[#202020] font-semibold">6.4</strong> Em caso de violação de Direitos de Propriedade Intelectual, o Participante deverá cessar imediatamente a infração e remover o material infrator. O AliExpress24 poderá limitar ou encerrar o acesso ao DS Center ou à Plataforma e congelar o saldo, quando aplicável.
            </p>
          </div>
        </div>
        ...
        <div className="bg-white rounded-none shadow-[0_1px_2px_rgba(0,0,0,0.03)] p-4 space-y-2.5">
          ...
          <div className="text-[12.5px] text-[#555555] leading-relaxed">
            <p>
              <strong className="text-[#202020] font-semibold">7.1</strong> Durante a participação no Programa, determinadas informações pessoais poderão ser recolhidas e processadas de acordo com o aviso de privacidade aplicável. O uso do DS Center e da Plataforma está sujeito à Política de Privacidade do AliExpress24.
            </p>
          </div>
        </div>
        ...
        <div className="bg-white rounded-none shadow-[0_1px_2px_rgba(0,0,0,0.03)] p-4 space-y-2.5">
          ...
          <div className="text-[12.5px] text-[#555555] leading-relaxed space-y-2.5">
            ...
            <p>
              <strong className="text-[#202020] font-semibold">9.4</strong> O AliExpress24 não será responsável por questões decorrentes da violação das cláusulas 5, 6, 7 e 8 pelo Participante e poderá exigir indenização pelas perdas decorrentes do incumprimento, nos termos deste Contrato.
            </p>
          </div>
        </div>
      </main>
